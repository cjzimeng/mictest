...
test_host = 'https://miniapptest.yujianmeihao.net'

class TestMicapptest:
    def test_login(self):
        r = requests.post(test_host+'/api/micro-service/relation/wx-user',
                          headers = headers,
                          json={
    ...
    def test_get_list(self):
        r = requests.post(test_host+'/api/micro-service/productswx',
                          headers=headers,
    ...
    def test_prodetail(self):
        ...
        r = requests.get(test_host+'/api/micro-service/product/'+proid,
                         headers=headers)
        assert r.json()['message'] == '成功'
        print(r.json())
    ...
    #     # 查询产品线路ID
    #     r = requests.get(test_host+'/api/micro-service/lines',
    #                      headers=headers,
    ...
    #
    #     # 创建订单
    #     r = requests.post(test_host+'/api/micro-service/order/draft/86',
    #                       headers=headers,
    ...
    #
    #     # 预订订单
    #     r = requests.post(test_host+'/api/micro-service/person-data/product-reserve',
    #                       headers=headers,
    #                       json={
    #                           "userId": 86,
    #                           "userCode": 707827,
    ...
    #
    #     # 取消订单
    #     r = requests.put(test_host+'/api/micro-service/order/pre/cancel/' + str(orderid),
    #                      headers=headers)
    #     print(r.json()['data']['validCode'])
    #     validcode = r.json()['data']['validCode']
    #     r = requests.put(test_host+'/api/micro-service/order/miniapp-cancel/',
    #                      headers=headers,
    #                      json={
    #                          'orderId': orderid,
    #                          'validCode': validcode,
